...
mod tests {
    ...
    use secret_toolkit_crypto::{sha_256, secp256k1::{PrivateKey}};
    use secret_toolkit_crypto::secp256k1::PRIVATE_KEY_SIZE;
    ...
    fn test_sign() {
        ...
        let signature = pk.sign(data, deps.api);

        let pubkey = pk.pubkey();
        assert!(pubkey.verify(&data_hash, signature, deps.api));
    }
